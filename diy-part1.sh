...
rm -rf package/openwrt-packages/luci-theme-argon && git clone git clone -b 18.06 https://github.com/jerrykuku/luci-theme-argon.git package/openwrt-packages/luci-theme-argon
