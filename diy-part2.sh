...
sed -i "22i sed -i '13i option delegate 0' /etc/config/network" package/lean/default-settings/files/zzz-default-settings
...
sed -i "26i sed -i '/option ra_management/d' /etc/config/dhcp" package/lean/default-settings/files/zzz-default-settings
sed -i "27i sed -i '/option dhcpv6/d' /etc/config/dhcp" package/lean/default-settings/files/zzz-default-settings
sed -i "28i sed -i '/option ra/d' /etc/config/dhcp" package/lean/default-settings/files/zzz-default-settings
...
sed -i "37i uci set wireless.@wifi-device[1].disabled=1" package/lean/default-settings/files/zzz-default-settings
